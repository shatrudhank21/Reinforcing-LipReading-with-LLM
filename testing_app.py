...
if options: 
    ...
    with col1: 
        ...
        os.system(f'ffmpeg -i {file_path} -vcodec libx264 test/test_video.mp4 -y')  ##optional if the format is in some other format than 'mp4'.

        # Render the video
        video = open('test/test_video.mp4', 'rb') 
